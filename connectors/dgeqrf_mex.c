...
void dgeqrf_(mwSignedIndex *m, mwSignedIndex *n, double *A, mwSignedIndex *lda,
             double *tau, double *work, mwSignedIndex *lwork, mwSignedIndex *info);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    dgeqrf_(&m, &n, A, &lda, tau, &work_opt, &lwork, &info);
