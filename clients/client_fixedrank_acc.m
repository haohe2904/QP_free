function data = client_fixedrank_acc(m, n, k, P, A, eqindices, ineqindices, methodoptions, setting)
%% Manifold factory
...
% [xfinal, costfinal, residual,stopreason] = QP_free_rank2(m, n, k, P, A, eqindices, ineqindices, x0, options);

fprintf('Starting QP_free_mex \n');
 [xfinal, costfinal, residual,stopreason] = QP_free_rank2_mex(m, n, k, P, A, eqindices, ineqindices, x0, options);
