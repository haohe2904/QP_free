function [xfinal, costfinal, residual, KKTdata, Timedata, Xdata, stopreason] = QP_free_rank2_plot(m, n, k, P, A, eqindices, ineqindices, x0, options)
    ...
    % KKTdata, Timedata, Xdata
    KKTdata = zeros(maxiter,1);
    Timedata = zeros(maxiter,1);
    Xdata = cell(maxiter,1);
